...
<img src="https://i.pinimg.com/236x/fc/da/ff/fcdaff4d3f30005e462d0d3c31cfb691.jpg">

<p>
  Reporitorio que alamacena todos los archivos 📁 de CSS 🎨. Se pueden ver como clases de la
  herramienta, para quien este interesado en aprender lo básico de CSS 🎨.  
</p>
...
1. Clona el repositorio:
    ...
    ```
    git clone https://github.com/Bredalis/CSS.git
    ```
